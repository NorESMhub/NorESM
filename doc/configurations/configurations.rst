...
A user guide for the AeroTab code, as well as the corresponding CAM6-Nor (OsloAero) code which is using the AeroTab LUT, will soon be available here. Until then, this presentation can be used as a first introduction: https://github.com/Kirkevag/NorESM/blob/noresm2/doc/configurations/AeroTab-slides-updateJan2020.pdf . For questions about AeroTab, contakt Alf Kirkevåg (alfk at met.no) or Øyvind Seland (oyvinds at met.no).      
